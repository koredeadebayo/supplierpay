...
var AccountsetComponent = /** @class */ (function () {
    function AccountsetComponent() {
    }
    AccountsetComponent.prototype.ngOnInit = function () {
    };
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(validateService, flashMessage, authService, router, paymentService, supplierService) {
...
var MakepayComponent = /** @class */ (function () {
    function MakepayComponent(validateService, flashMessage, authService, router, paymentService, supplierService) {
        this.validateService = validateService;
        this.flashMessage = flashMessage;
        this.authService = authService;
        this.router = router;
    ...
    MakepayComponent.prototype.ngOnInit = function () {
        var _this = this;
        //Get List of Suppliet from Database
        this.supplierService.getSuppliers().subscribe(function (data) {
            _this.supplierData = data;
            // console.log(data);
            // this.flashMessage.show('You are now register and can log in', {cssClass: 'alert-success', timeout:3000});
            // this.router.navigate(['/login']); 
        }, function (error) {
    ...
    MakepayComponent.prototype.onPaymentSubmit = function (formData) {
        var _this = this;
        var payment = {
        ...
        this.paymentService.makePayments(payment).subscribe(function (data) {
            _this.successMsg = "Payment Successful";
            // this.flashMessage.show('Payment Successful', {cssClass: 'alert-success', timeout:3000});
            _this.router.navigate(['/makepay']);
        }, function (error) {
    ...
    MakepayComponent.ctorParameters = function () { return [
        { type: _services_validate_service__WEBPACK_IMPORTED_MODULE_2__["ValidateService"] },
        { type: angular2_flash_messages__WEBPACK_IMPORTED_MODULE_3__["FlashMessagesService"] },
        { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
...
var ManagesupComponent = /** @class */ (function () {
    function ManagesupComponent(validateService, flashMessage, authService, router, supplierService, paymentService) {
        this.validateService = validateService;
        this.flashMessage = flashMessage;
        this.authService = authService;
        this.router = router;
    ...
    ManagesupComponent.prototype.ngOnInit = function () {
        var _this = this;
        //Get List of Suppliet from Database
        this.supplierService.getSuppliers().subscribe(function (data) {
            _this.supplierData = data;
    ...
    ManagesupComponent.prototype.onSupplierSubmit = function (formData) {
        var _this = this;
        var supplier = {
            name: formData.name,
        ...
        //Add Supplier
        this.supplierService.makeSupplier(supplier).subscribe(function (data) {
            _this.successMsg = "Supplier add";
            // this.flashMessage.show('You are now register and can log in', {cssClass: 'alert-success', timeout:3000});
            _this.router.navigate(['/managesup']);
        }, function (error) {
            _this.errorMsg = "Something went wrong";
            // this.flashMessage.show('Something went wrong', {cssClass: 'alert-danger', timeout:3000});
    ...
    ManagesupComponent.ctorParameters = function () { return [
        { type: _services_validate_service__WEBPACK_IMPORTED_MODULE_2__["ValidateService"] },
        { type: angular2_flash_messages__WEBPACK_IMPORTED_MODULE_3__["FlashMessagesService"] },
        { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function (formData) {
        var _this = this;
        var user = {
            name: formData.name,
...
var PaymentService = /** @class */ (function () {
    ...
    PaymentService.prototype.makePayments = function (payment) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json');
...
var SupplierService = /** @class */ (function () {
    ...
    SupplierService.prototype.makeSupplier = function (supplier) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json');
...
var ValidateService = /** @class */ (function () {
    ...
    ValidateService.prototype.validatePayment = function (payment) {
    ...
    ValidateService.prototype.validateSupplier = function (supplier) {
